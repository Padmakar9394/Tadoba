        ...
        <SwiperSlide>
          <div class="swiper-slide">
            ...
            <div class="one animate fadeUp text1 w-5/12 left-16 mb-16">
                <h2 className="text-4xl font-bold uppercase">Get that wild safari experience, morning, evening and night</h2>
        ...
        <SwiperSlide>
          <div class="swiper-slide">
            <div class="slide3 swiper-slide-cover"></div>
              <div class="one animate fadeUp text1 w-5/12 left-16 mb-16">
                  <h2 className="text-4xl font-bold uppercase">Our Frontline Forest Guardians need your support</h2>
