  ...
  return (
    <>
      <div className="px-16">
        ...
        <div className="px-8 flex items-center gap-20 font-['Roboto_Slab'] my-12">
          ...
          <p className="font-['Roboto_Slab'] text-4xl text-[#8ac5d7] text-center">
      ...
      <div className="px-16">
        <div className="px-8 flex items-center gap-20 font-['Roboto_Slab'] my-12">
          ...
          <p className="font-['Roboto_Slab'] text-3xl text-[#8ac5d7] text-center px-20">
      ...
      <section className="bg-[#EBEBEB]">
        <div className="flex px-16">
          <span className="flex-initial w-1/4"><WildLifeGallerySliderMammels /></span>
          <span className="flex-initial w-1/4"><WildLifeGallerySliderReptiles /></span>
          <span className="flex-initial w-1/4"><WildLifeGallerySliderInscets /></span>
          <span className="flex-initial w-1/4"><WildLifeGallerySliderBirds /></span>
        </div>
      </section>
    </>
  )
